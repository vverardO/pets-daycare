...
class UpdateTest extends TestCase
{
    ...
    public function test_updating_one_owner(): void
    {
        $owner = Owner::factory()->create();

        $stubOwner = Owner::factory()->make();

        $response = $this->put("/api/owners/{$owner->id}", [
            'name' => $stubOwner->name,
    ...
    public function test_general_record_and_registration_physical_person_are_unique(): void
    {
        ...
        $secondOwner = Owner::factory()->create();

        $response = $this->put("/api/owners/{$owner->id}", [
            'general_record' => $secondOwner->general_record,
            'registration_physical_person' => $secondOwner->registration_physical_person,
        ]);
